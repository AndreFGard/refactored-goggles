  ...
  return (
    <div className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-40">
      ...
      <div>
        ...
        <p className="text-[#4e974e] text-sm font-normal leading-normal">{members}</p>
      </div>
    </div>
  )
}
...
const GroupSection: React.FC<GroupSectionProps> = ({ title, groups }) => {
  return (
    <>
      <h2 className="text-[#0e1b0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">{title}</h2>
