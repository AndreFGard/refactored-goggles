			...
			{isSearchOpen && (
				<div className="absolute top-16 left-4 right-4 bg-white border border-gray-200 rounded-lg shadow-lg p-3 z-10">
					<input
						...
						className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0e1b0e] focus:border-transparent"
						autoFocus
					/>
				</div>
			)}
...
const GroupCard: React.FC<GroupCardProps> = ({ name, members, image }) => {
	return (
		<div className="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-40">
			...
			/>
			<div>
				<p className="text-[#0e1b0e] text-base font-medium leading-normal">
					{name}
				</p>
